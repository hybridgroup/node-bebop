...
var ARDroneCommands = new Promise(function (resolve, reject) {
  request('https://raw.githubusercontent.com/Parrot-Developers/arsdk-xml/master/xml/ardrone3.xml', function (err, res, xml) {
    resolve(parser.toJson(xml));
  })
})

var CommonCommands = new Promise(function (resolve, reject) {
  request('https://raw.githubusercontent.com/Parrot-Developers/arsdk-xml/master/xml/common.xml', function (err, res, xml) {
    resolve(parser.toJson(xml));
  })
})
