...
var Bebop = module.exports = function(opts) {
  ...
  this._pcmd = {};
  this.Piloting = new require("./Piloting")(this);
  this.Animations = new require("./Animations")(this);
  this.Camera = new require("./Camera")(this);
  this.MediaRecord = new require("./MediaRecord")(this);
  this.MediaRecordState = new require("./MediaRecordState")(this);
  this.MediaRecordEvent = new require("./MediaRecordEvent")(this);
  this.PilotingState = new require("./PilotingState")(this);
  this.PilotingEvent = new require("./PilotingEvent")(this);
  this.Network = new require("./Network")(this);
  this.NetworkState = new require("./NetworkState")(this);
  this.PilotingSettings = new require("./PilotingSettings")(this);
  this.PilotingSettingsState = new require("./PilotingSettingsState")(this);
  this.SpeedSettings = new require("./SpeedSettings")(this);
  this.SpeedSettingsState = new require("./SpeedSettingsState")(this);
  this.NetworkSettings = new require("./NetworkSettings")(this);
  this.NetworkSettingsState = new require("./NetworkSettingsState")(this);
  this.Settings = new require("./Settings")(this);
  this.SettingsState = new require("./SettingsState")(this);
  this.DirectorMode = new require("./DirectorMode")(this);
  this.DirectorModeState = new require("./DirectorModeState")(this);
  this.PictureSettings = new require("./PictureSettings")(this);
  this.PictureSettingsState = new require("./PictureSettingsState")(this);
  this.MediaStreaming = new require("./MediaStreaming")(this);
  this.MediaStreamingState = new require("./MediaStreamingState")(this);
  this.GPSSettings = new require("./GPSSettings")(this);
  this.GPSSettingsState = new require("./GPSSettingsState")(this);
  this.CameraState = new require("./CameraState")(this);
  this.Antiflickering = new require("./Antiflickering")(this);
  this.AntiflickeringState = new require("./AntiflickeringState")(this);
  this.GPSState = new require("./GPSState")(this);
  this.PROState = new require("./PROState")(this);
  this.Network = new require("./Network")(this);
  this.NetworkEvent = new require("./NetworkEvent")(this);
  this.Settings = new require("./Settings")(this);
  this.SettingsState = new require("./SettingsState")(this);
  this.Common = new require("./Common")(this);
  this.CommonState = new require("./CommonState")(this);
  this.OverHeat = new require("./OverHeat")(this);
  this.OverHeatState = new require("./OverHeatState")(this);
  this.ControllerState = new require("./ControllerState")(this);
  this.WifiSettings = new require("./WifiSettings")(this);
  this.WifiSettingsState = new require("./WifiSettingsState")(this);
  this.Mavlink = new require("./Mavlink")(this);
  this.MavlinkState = new require("./MavlinkState")(this);
  this.Calibration = new require("./Calibration")(this);
  this.CalibrationState = new require("./CalibrationState")(this);
  this.CameraSettingsState = new require("./CameraSettingsState")(this);
  this.GPS = new require("./GPS")(this);
  this.FlightPlanState = new require("./FlightPlanState")(this);
  this.FlightPlanEvent = new require("./FlightPlanEvent")(this);
  this.ARLibsVersionsState = new require("./ARLibsVersionsState")(this);
  this.Audio = new require("./Audio")(this);
  this.AudioState = new require("./AudioState")(this);
  this.Headlights = new require("./Headlights")(this);
  this.HeadlightsState = new require("./HeadlightsState")(this);
  this.Animations = new require("./Animations")(this);
  this.AnimationsState = new require("./AnimationsState")(this);
  this.Accessory = new require("./Accessory")(this);
  this.AccessoryState = new require("./AccessoryState")(this);
  this.Charger = new require("./Charger")(this);
  this.ChargerState = new require("./ChargerState")(this);
};
