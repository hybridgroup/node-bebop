...
function networkFrameGenerator() {
  ...
  var seq = {
    1: 0,  // ARNETWORK_MANAGER_INTERNAL_BUFFER_ID_PONG
...
Bebop.prototype._createPong = function(arstreamFrame) {
  return this._networkFrameGenerator(arstreamFrame.data, ARNETWORKAL_FRAME_TYPE_DATA, ARNETWORK_MANAGER_INTERNAL_BUFFER_ID_PONG);
}
