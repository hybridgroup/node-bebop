...
var Bebop = module.exports = function(opts) {
  ...
  this.rtcStreamPort = opts.rtcStreamPort || 55004;
  this.rtcControlPort = opts.rtcControlPort || 55005;
...
Bebop.prototype.discover = function(callback) {
  this._discoveryClient.connect(this.discoveryPort, this.ip, function() {
    this._discoveryClient.write(JSON.stringify({
      ...
      "arstream2_client_stream_port": this.rtcStreamPort.toString(),
      "arstream2_client_control_port": this.rtcControlPort.toString()
    }));
  }.bind(this));
