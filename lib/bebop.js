...
var EventEmitter = require("events").EventEmitter,
    ...
    MediaRecordState = require("./MediaRecordState"),
    MediaRecordEvent = require("./MediaRecordEvent"),
    PilotingState = require("./PilotingState"),
    PilotingEvent = require("./PilotingEvent"),
    Network = require("./Network"),
    NetworkState = require("./NetworkState"),
    PilotingSettings = require("./PilotingSettings"),
    PilotingSettingsState = require("./PilotingSettingsState"),
    SpeedSettings = require("./SpeedSettings"),
    SpeedSettingsState = require("./SpeedSettingsState"),
    NetworkSettings = require("./NetworkSettings"),
    NetworkSettingsState = require("./NetworkSettingsState"),
    Settings = require("./Settings"),
    SettingsState = require("./SettingsState"),
    DirectorMode = require("./DirectorMode"),
    DirectorModeState = require("./DirectorModeState"),
    PictureSettings = require("./PictureSettings"),
    PictureSettingsState = require("./PictureSettingsState"),
    MediaStreaming = require("./MediaStreaming"),
    MediaStreamingState = require("./MediaStreamingState"),
    GPSSettings = require("./GPSSettings"),
    GPSSettingsState = require("./GPSSettingsState"),
    CameraState = require("./CameraState"),
    Antiflickering = require("./Antiflickering"),
    AntiflickeringState = require("./AntiflickeringState"),
    GPSState = require("./GPSState"),
    ...
    OverHeatState = require("./OverHeatState"),
    ControllerState = require("./ControllerState"),
    WifiSettings = require("./WifiSettings"),
    WifiSettingsState = require("./WifiSettingsState"),
    Mavlink = require("./Mavlink"),
    MavlinkState = require("./MavlinkState"),
    Calibration = require("./Calibration"),
    CalibrationState = require("./CalibrationState"),
    CameraSettingsState = require("./CameraSettingsState"),
    GPS = require("./GPS"),
    FlightPlanState = require("./FlightPlanState"),
    ...
    HeadlightsState = require("./HeadlightsState"),
    Animations = require("./Animations"),
...
var Bebop = module.exports = function(opts) {
  ...
  this.MediaRecordState = new MediaRecordState(this);
  this.MediaRecordEvent = new MediaRecordEvent(this);
  this.PilotingState = new PilotingState(this);
  ...
  this.PilotingSettingsState = new PilotingSettingsState(this);
  this.SpeedSettings = new SpeedSettings(this);
  this.SpeedSettingsState = new SpeedSettingsState(this);
  this.NetworkSettings = new NetworkSettings(this);
  this.NetworkSettingsState = new NetworkSettingsState(this);
  this.Settings = new Settings(this);
  this.SettingsState = new SettingsState(this);
  this.DirectorMode = new DirectorMode(this);
  this.DirectorModeState = new DirectorModeState(this);
  this.PictureSettings = new PictureSettings(this);
  this.PictureSettingsState = new PictureSettingsState(this);
  this.MediaStreaming = new MediaStreaming(this);
  this.MediaStreamingState = new MediaStreamingState(this);
  this.GPSSettings = new GPSSettings(this);
  this.GPSSettingsState = new GPSSettingsState(this);
  this.CameraState = new CameraState(this);
  this.Antiflickering = new Antiflickering(this);
  this.AntiflickeringState = new AntiflickeringState(this);
  this.GPSState = new GPSState(this);
  ...
  this.OverHeatState = new OverHeatState(this);
  this.ControllerState = new ControllerState(this);
  this.WifiSettings = new WifiSettings(this);
  this.WifiSettingsState = new WifiSettingsState(this);
  this.Mavlink = new Mavlink(this);
  this.MavlinkState = new MavlinkState(this);
  this.Calibration = new Calibration(this);
  this.CalibrationState = new CalibrationState(this);
  this.CameraSettingsState = new CameraSettingsState(this);
  this.GPS = new GPS(this);
  this.FlightPlanState = new FlightPlanState(this);
  ...
  this.HeadlightsState = new HeadlightsState(this);
  this.Animations = new Animations(this);
