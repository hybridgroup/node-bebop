...
PictureSettings.prototype.videoRecordingMode = function(mode) {

  var buffer = commandToBuffer(1, "PictureSettings", "VideoRecordingMode",
                               mode);
...
PictureSettings.prototype.videoFramerate = function(framerate) {

  var buffer = commandToBuffer(1, "PictureSettings", "VideoFramerate",
                               framerate);
...
PictureSettings.prototype.videoResolutions = function(framerate) {

  var buffer = commandToBuffer(1, "PictureSettings", "VideoResolutions",
                               framerate);
